...
public class NPCInfoMono : MonoBehaviour
{
    ...
    {
        m_imageNPC.sprite = Resources.Load<Sprite>("Sprites/PortraitsNoColor/" + npc.Image);
        ...
        if (npc.cat != null)
        {
            m_imageCat.sprite = Resources.Load<Sprite>("Sprites/PortraitsNoColor/" + npc.cat.Image);
